<?php
/*	Template Name: Self-catered list
 * The template for displaying the self-catered list.
 *
 * @package WordPress
...
if (isset($page_custom_fields['self_catered_list_location_post_id'])) {
	$parent_location_id = $page_custom_fields['self_catered_list_location_post_id'][0];
...
?>
	<section class="full">
		...
		<?php endwhile; ?>
		<?php
			$accommodation_results = list_accommodations($paged, $posts_per_page, 'post_title', 'ASC', $parent_location_id, $accommodation_type_ids, array(), false, true );
		?>		
