...
/*-----------------------------------------------------------------------------------*/
	...
	function byt_Social_Widget() {
		...
		/* Create the widget. */
		$this->WP_Widget( 'byt_social_widget', __('BookYourTravel: Social Widget', 'bookyourtravel'), $widget_ops, $control_ops );
	}
	...
	function widget( $args, $instance ) {
		...
		?>
			<article class="one-fourth">
				<h3><?php _e('Follow us', 'bookyourtravel'); ?></h3>
				<ul class="social"> <?php
...
/*-----------------------------------------------------------------------------------*/
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'facebook_id' ); ?>"><?php _e('Facebook ID:', 'bookyourtravel') ?></label>
			<input type="text" class="widefat" id="<?php echo $this->get_field_id( 'facebook_id' ); ?>" name="<?php echo $this->get_field_name( 'facebook_id' ); ?>" value="<?php echo $instance['facebook_id']; ?>" />
		</p>

		<p>
			<label for="<?php echo $this->get_field_id( 'twitter_id' ); ?>"><?php _e('Twitter ID:', 'bookyourtravel') ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'youtube_profile' ); ?>"><?php _e('Youtube url:', 'bookyourtravel') ?></label>
			<input type="text" class="widefat" id="<?php echo $this->get_field_id( 'youtube_profile' ); ?>" name="<?php echo $this->get_field_name( 'youtube_profile' ); ?>" value="<?php echo $instance['youtube_profile']; ?>" />
		</p>

		<p>
			<label for="<?php echo $this->get_field_id( 'rss_feed' ); ?>"><?php _e('Rss feed:', 'bookyourtravel') ?></label>
			<input type="text" class="widefat" id="<?php echo $this->get_field_id( 'rss_feed' ); ?>" name="<?php echo $this->get_field_name( 'rss_feed' ); ?>" value="<?php echo $instance['rss_feed']; ?>" />
		</p>		

		<p>
			<label for="<?php echo $this->get_field_id( 'linked_in_profile' ); ?>"><?php _e('LinkedIn url:', 'bookyourtravel') ?></label>
			<input type="text" class="widefat" id="<?php echo $this->get_field_id( 'linked_in_profile' ); ?>" name="<?php echo $this->get_field_name( 'linked_in_profile' ); ?>" value="<?php echo $instance['linked_in_profile']; ?>" />
		</p>		

		<p>
			<label for="<?php echo $this->get_field_id( 'gplus_profile' ); ?>"><?php _e('GPlus url:', 'bookyourtravel') ?></label>
			<input type="text" class="widefat" id="<?php echo $this->get_field_id( 'gplus_profile' ); ?>" name="<?php echo $this->get_field_name( 'gplus_profile' ); ?>" value="<?php echo $instance['gplus_profile']; ?>" />
		</p>		

		<p>
			<label for="<?php echo $this->get_field_id( 'vimeo_profile' ); ?>"><?php _e('Vimeo profile:', 'bookyourtravel') ?></label>
			<input type="text" class="widefat" id="<?php echo $this->get_field_id( 'vimeo_profile' ); ?>" name="<?php echo $this->get_field_name( 'vimeo_profile' ); ?>" value="<?php echo $instance['vimeo_profile']; ?>" />
		</p>		

		<p>
			<label for="<?php echo $this->get_field_id( 'pinterest_profile' ); ?>"><?php _e('Pinterest url:', 'bookyourtravel') ?></label>
			<input type="text" class="widefat" id="<?php echo $this->get_field_id( 'pinterest_profile' ); ?>" name="<?php echo $this->get_field_name( 'pinterest_profile' ); ?>" value="<?php echo $instance['pinterest_profile']; ?>" />
		</p>		
