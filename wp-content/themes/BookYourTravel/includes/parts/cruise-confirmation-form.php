<?php do_action( 'byt_show_cruise_confirm_form_before' ); ?>
<form id="cruise-confirmation-form" method="post" action="" class="booking" style="display:none">
	<fieldset>
		<h3><span>02 </span><?php _e('Confirmation', 'bookyourtravel') ?></h3>
		<div class="text-wrap">
			<p><?php _e('Thank you. We will get back you with regards your cruise booking within 24 hours.', 'bookyourtravel') ?></p>
		</div>				
		...
		<div class="text-wrap">
			<div class="output">
				...
				<p><?php _e('Cruise start date', 'bookyourtravel') ?>:</p>
				<p id="confirm_cruise_start_date"></p>
				<p><?php _e('Cruise', 'bookyourtravel') ?>:</p>
				<p id="confirm_cruise_title"></p>
				<p><?php _e('Adults', 'bookyourtravel') ?>:</p>
				<p id="confirm_cruise_adults"></p>
				<p><?php _e('Children', 'bookyourtravel') ?>:</p>
				<p id="confirm_cruise_children"></p>
				<p><?php _e('Total price', 'bookyourtravel') ?>:</p>
				<p id="confirm_cruise_total"></p>				
			</div>
		</div>			
...
<?php do_action( 'byt_show_cruise_confirm_form_after' ); ?>